#!/usr/bin/env python3
"""
MCD-rPPG Dataset Preprocessing Script 1

This script processes the first third of videos (camera 1 - frontal webcam).
It performs face detection using MediaPipe, cropping, and saves processed faces and landmarks.

Usage:
    python dataset_preprocessing_1.py [--input_path INPUT] [--output_path OUTPUT] [--num_workers N]
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='Preprocess MCD-rPPG dataset - Camera 1 (frontal webcam) using MediaPipe',
...
def main():
    ...
    print("=" * 80)
    print("MCD-rPPG Dataset Preprocessing Script 1")
    print(f"Camera: {args.camera_id} (Frontal Webcam)")

#!/usr/bin/env python3
"""
MCD-rPPG Dataset Preprocessing Script 2

This script processes the second third of videos (camera 2 - FullHD camcorder).
It performs face detection using MediaPipe, cropping, and saves processed faces and landmarks.

Usage:
    python dataset_preprocessing_2.py [--input_path INPUT] [--output_path OUTPUT] [--num_workers N]
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='Preprocess MCD-rPPG dataset - Camera 2 (FullHD camcorder) using MediaPipe',
...
def get_video_list(args):
    ...
    # For this script, process every 3rd video starting from index 1
    videos = videos[1::3]
...
def main():
    ...
    print("=" * 80)
    print("MCD-rPPG Dataset Preprocessing Script 2")
    print(f"Camera: {args.camera_id} (FullHD Camcorder)")
